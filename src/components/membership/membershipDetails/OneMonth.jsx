          ...
          <div className="row">
            <div className="col-lg-3 col-sm-6">
              <div className="single-plan memDown">
                ...
                <p>Save 0% on 1 Month</p>
                <Link
                  to={`/checkout/membership/${oneMonth[0]?.id}`}
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="single-plan memDown">
                ...
                <h4 className="number mb-2">
                  <sup>$</sup> {oneMonth[1]?.fee}
                </h4>
                <p>Save 0% on 1 Month</p>
                <Link
                  to={`/checkout/membership/${oneMonth[1]?.id}`}
                  className="custom-button mb-4"
                >
                  Buy Now!
                </Link>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="single-plan memDown">
                ...
                <h4 className="number mb-2">
                  <sup>$</sup> {oneMonth[2]?.fee}
                </h4>
                <p>Save 0% on 1 Month</p>
                <Link
                  to={`/checkout/membership/${oneMonth[2]?.id}`}
                  className="custom-button mb-4"
                >
                  Buy Now!
                </Link>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="single-plan memDown">
                ...
                <h4 className="number mb-2">
                  <sup>$</sup> {oneMonth[3]?.fee}
                </h4>
                <p>Save 0% on 1 Month</p>
                <Link
                  to={`/checkout/membership/${oneMonth[3]?.id}`}
                  className="custom-button mb-4"
                >
                  Buy Now!
                </Link>
