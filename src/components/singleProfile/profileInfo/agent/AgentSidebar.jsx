...
function AgentSidebar({ sidebar, id }) {
  // console.log("id", id);
        ...
        >
          <div className="card-body">
            <ul className="links">
              ...
              <li onClick={() => dispatch(sidebarNow("AgentServices"))}>
                <a className={sidebar === "AgentServices" ? "active" : ""}>
                  Services
                </a>
              </li>
              <li onClick={() => dispatch(sidebarNow("AgentCase"))}>
                <a className={sidebar === "AgentCase" ? "active" : ""}>
                  Contact
                </a>
              </li>
            </ul>
